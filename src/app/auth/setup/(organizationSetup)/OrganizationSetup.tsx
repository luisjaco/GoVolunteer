...
export default function OrganizationSetup() {
    ...
    const pickImage = async () => {
        console.log('[OrganizationSetup] user initiated local image upload');
        ...
        if (result.canceled) {
            console.log('[OrganizationSetup] user canceled image upload');
        } else {
            setProfilePicture(result.assets[0]);
            console.log("[OrganizationSetup] image uploaded locally: ", result);
        }
    };
